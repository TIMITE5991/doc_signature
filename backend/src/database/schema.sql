...
CREATE TABLE t_recipients (
  ...
  signature_path    VARCHAR(500),
  sig_x_ratio       DECIMAL(5,4) NULL COMMENT 'Zone X prédéfinie par émetteur (0..1)',
  sig_y_ratio       DECIMAL(5,4) NULL COMMENT 'Zone Y prédéfinie par émetteur (0..1)',
  sig_doc_id        INT NULL COMMENT 'Document cible de la zone prédéfinie',
